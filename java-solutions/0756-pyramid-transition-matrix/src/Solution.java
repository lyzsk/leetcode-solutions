...
public class Solution {
    ...
    public boolean pyramidTransition(String bottom, List<String> allowed) {
        ...
        return backtrack(0, new StringBuilder(), new StringBuilder(bottom), bottom.length() - 1,
            hset);
    }

    private boolean backtrack(int i, StringBuilder current, StringBuilder base, int n,
        Set<String> allowed) {
        if (n == 0) {
            return true;
        }
